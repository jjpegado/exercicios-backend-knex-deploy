...
const obterProduto = async (req, res) => {
    ...
    try {
        ...
        const produtos = await knex('produtos').where({usuario_id: usuario.id, id})
...
const cadastrarProduto = async (req, res) => {
    ...
    try {
        ...
        const produto = await knex('produtos').insert({usuario_id: usuario.id, nome, estoque, preco, categoria, descricao, imagem}).returning('*')
...
const atualizarProduto = async (req, res) => {
    ...
    try {
        ...
        const produtoAtualizado = await knex('produtos').update({
            ...
            preco: body.preco,
            imagem: body.imagem }).where({id}).andWhere('usuario_id', usuario.id).returning('*');
...
const excluirProduto = async (req, res) => {
    ...
    try {
        ...
        const produtos = await knex('produtos').where({id}).andWhere({usuario_id: usuario.id})
